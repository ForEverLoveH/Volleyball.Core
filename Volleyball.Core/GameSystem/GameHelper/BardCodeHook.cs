...
namespace Volleyball.Core.GameSystem.GameHelper
{
    ...
    public class BardCodeHook
    {
        ...
        private BarCodes barCode = new BarCodes();
        ...
        public bool Start()
        {
            if (hKeyboardHook == 0)
            {
                ...
                //WH_KEYBOARD_LL=13
                hKeyboardHook = SetWindowsHookEx(13, KeyboardHookDelegate, Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]), 0);
            }
